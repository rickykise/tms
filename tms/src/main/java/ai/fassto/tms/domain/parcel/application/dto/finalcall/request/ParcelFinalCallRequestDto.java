...
public record ParcelFinalCallRequestDto(
        @NotBlank
        ...
        @Schema(description = "고객사 명", example = "테스트고객")
        ...
        @Schema(description = "상품출고일(집하요청일자)", example = "20230220", requiredMode = Schema.RequiredMode.REQUIRED)
        ...
        @NotBlank
        @Schema(description = "보내는사람 전화번호", example = "010-1111-2222", requiredMode = Schema.RequiredMode.REQUIRED)
        String senderPhone,             // 보내는사람 전화번호 ( "-" 로 각 자리가 구분되어있음 )
        @Schema(description = "보내는사람 전화번호2", example = "010-2222-3333")
        ...
        @Schema(description = "보내는사람 상세주소", example = "102동 1123호", requiredMode = Schema.RequiredMode.REQUIRED)
        ...
        @NotBlank
        @Schema(description = "받는사람 전화번호", example = "01033334444", requiredMode = Schema.RequiredMode.REQUIRED)
        String receiverPhone,          // 받는사람 전화번호 ( "-" 로 각 자리가 구분되어있음 )
        @Schema(description = "받는사람 전화번호2", example = "01044445555")
